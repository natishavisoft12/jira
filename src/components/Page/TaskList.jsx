    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
            ...
            <div className="flex space-x-6 mb-6">
                <Link to="/complete" className="px-6 py-3 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 transition duration-300 flex justify-center items-center gap-2">
                    <MdOutlineIncompleteCircle/> Completed ({completedTasks.length})
                </Link>
                <Link to="/pending" className="px-6 py-3 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600 transition duration-300 flex justify-center items-center gap-2">
                    <MdPending/> Pending ({pendingTasks.length})
                </Link>
                <Link to="/ongoing" className="px-6 py-3 bg-yellow-500 text-white rounded-lg shadow-md hover:bg-yellow-600 transition duration-300 flex justify-center items-center gap-2">
                    <RiProgress1Fill/> Ongoing ({ongoingTasks.length})
                </Link>
                <button
                    onClick={() => navigate("/addNewtask")}
                    className="px-6 py-3 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 transition duration-300 flex justify-center items-center gap-2">
